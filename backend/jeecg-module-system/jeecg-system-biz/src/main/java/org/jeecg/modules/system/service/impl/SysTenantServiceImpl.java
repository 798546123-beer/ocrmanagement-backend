...
public class SysTenantServiceImpl extends ServiceImpl<SysTenantMapper, SysTenant> implements ISysTenantService {
   ...
   public int tenantIdGenerate(){
    ...
    public Result<String> invitationUser(String phone, String departId) {
        ...
        //update-begin---author:wangshuai ---date:20230329  for：[QQYUN-4671]公司与用户，手机号邀请，没有在当前公司下，目前是在全组织中------------
        //6.保存用户公司关系
        if(oConvertUtils.isNotEmpty(departId)){
            //保存用户公司关系
            this.saveUserDepart(userByPhone.getId(),departId);
        }
        //update-end---author:wangshuai ---date:20230329  for：[QQYUN-4671]公司与用户，手机号邀请，没有在当前公司下，目前是在全组织中------------
    ...
    private void saveUserDepart(String userId, String departId) {
        //根据用户id和公司id获取数量,用于查看用户是否存在用户公司关系表中
