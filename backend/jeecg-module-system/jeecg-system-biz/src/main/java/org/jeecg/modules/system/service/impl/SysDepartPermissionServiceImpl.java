            ...
            for (String permissionId : delete) {
                ...
                if(roleIds != null && roleIds.size()>0){
                    departRolePermissionMapper.delete(new LambdaQueryWrapper<SysDepartRolePermission>()
                        ...
                        //update-begin-author:liusq---date:2023-10-08--for: [issue/#5339]公司管理下公司赋权代码逻辑缺少判断条件
                            .in(SysDepartRolePermission::getRoleId,roleIds)
                        //update-end-author:liusq---date:2023-10-08--for: [issue/#5339]公司管理下公司赋权代码逻辑缺少判断条件
                    );
                }
            }
        }
