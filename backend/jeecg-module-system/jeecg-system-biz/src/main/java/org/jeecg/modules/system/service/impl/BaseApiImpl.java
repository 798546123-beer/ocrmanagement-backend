...
//            return null;
//        }
//        LoginUser user = userService.getEncodeUserInfo(username);
...
//        String userId = userService.get(username);
        return null;
    }
...
//
//            //update-begin-author:taoyan date:2023-5-19 for: QQYUN-5326【简流】获取组织人员 单/多 筛选条件 没有公司筛选
...
//                    result.add(userJson);
//                }
//                //update-end-author:taoyan date:2023-5-19 for: QQYUN-5326【简流】获取组织人员 单/多 筛选条件 没有公司筛选
//
//            }
//        }
//        return result;
...
//
//    /**
//     * 判断用户的公司是否满足条件 -等于/不等于/在--中/不在--中/为空/不为空
//     * QQYUN-5326【简流】获取组织人员 单/多 筛选条件 没有公司筛选
...
//        return sysUserMapper.getUserAccountsByDepCode(orgCode);
//    }
//
//    @Override
