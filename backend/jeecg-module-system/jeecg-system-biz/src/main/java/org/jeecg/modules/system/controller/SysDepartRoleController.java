...
public class SysDepartRoleController extends JeecgController<SysDepartRole, ISysDepartRoleService> {
	 ...
	 * @return
	 */
	@ApiOperation(value="公司角色-分页列表查询", notes="公司角色-分页列表查询")
...
//		queryWrapper.in("depart_id",deptIds);
	...
	@ApiOperation(value="公司角色-添加", notes="公司角色-添加")
	 ...
	 * @return
	 */
	@ApiOperation(value="公司角色-编辑", notes="公司角色-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "公司角色-通过id删除")
	@ApiOperation(value="公司角色-通过id删除", notes="公司角色-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "公司角色-批量删除")
	@ApiOperation(value="公司角色-批量删除", notes="公司角色-批量删除")
	 ...
	 * @return
	 */
	@ApiOperation(value="公司角色-通过id查询", notes="公司角色-通过id查询")
	...
	public Result<List<SysDepartRole>> getDeptRoleList(@RequestParam(value = "departId") String departId,@RequestParam(value = "userId") String userId){
	 ...
	 public Result<?> deptRoleAdd(@RequestBody JSONObject json) {
         ...
         //update-begin---author:wangshuai ---date:20220316  for：[VUEN-234]公司角色分配添加敏感日志------------
         LoginUser loginUser = (LoginUser) SecurityUtils.getSubject().getPrincipal();
         baseCommonService.addLog("给公司用户ID："+userId+"分配角色，操作人： " +loginUser.getUsername() ,CommonConstant.LOG_TYPE_2, 2);
         //update-end---author:wangshuai ---date:20220316  for：[VUEN-234]公司角色分配添加敏感日志------------
         return Result.ok("添加成功！");
	 }
  ...
  public ModelAndView exportXls(HttpServletRequest request, SysDepartRole sysDepartRole) {
      return super.exportXls(request, sysDepartRole, SysDepartRole.class, "公司角色");
  }
