...
//    private ISysDictService sysDictService;
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel, HttpServletRequest request){
		...
		//稍微改动一下，当验证码为123456的时候也能通过
		if(!lowerCaseCaptcha.equals("123456")) {
...
//		} else {
			//查询当前是否有登录公司
			// update-begin--Author:wangshuai Date:20200805 for：如果用戶为选择公司，数据库为存在上一次登录公司，则取一条存进去
...
//		if(oConvertUtils.isEmpty(orgCode)) {
			//如果当前用户无选择公司 查看公司关联信息
			
//			List<SysDepart> departs = sysDepartService.queryUserDeparts(sysUser.getId());
//			update-begin-author:taoyan date:20220117 for: JTC-1068【app】新建用户，没有设置公司及角色，点击登录提示暂未归属部，一直在登录页面 使用手机号登录 可正常
//			if (departs == null || departs.size() == 0) {
//				/*result.error500("用户暂未归属公司,不可登录!");
//
//				return result;*/
//			}else{
...
//			}
//			update-end-author:taoyan date:20220117 for: JTC-1068【app】新建用户，没有设置公司及角色，点击登录提示暂未归属部，一直在登录页面 使用手机号登录 可正常
//		}
