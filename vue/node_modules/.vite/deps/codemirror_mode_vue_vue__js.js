import {
  require_htmlmixed
} from "./chunk-EWZQEHKU.js";
import {
  require_javascript
} from "./chunk-7RBA3TU7.js";
import {
  require_xml
} from "./chunk-ORLQT2J6.js";
import {
  require_css
} from "./chunk-BC7APJEF.js";
import {
  require_codemirror
} from "./chunk-GRD433IW.js";
import {
  __commonJS
    ...
    (function(mod) {
      ...
      CodeMirror2.defineMode("stylus", function(config) {
        ...
        states.interpolation = function(type2, stream, state) {
          if (type2 == "{") popContext(state) && pushContext(state, stream, "block");
          if (type2 == "}") {
      ...
      CodeMirror2.multiplexingMode = function(outer) {
        ...
        return {
              ...
              for (var i = 0; i < others.length; ++i) {
                ...
                if (found == stream.pos) {
                  ...
                  if (outer.indent) {
                    ...
                    if (possibleOuterIndent !== CodeMirror2.Pass) outerIndent = possibleOuterIndent;
                  }
          ...
          indent: function(state, textAfter, line) {
            ...
            if (!mode.indent) return CodeMirror2.Pass;
